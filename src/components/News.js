...
const News = () => {
  ...
  return (
    <div className="container mr-10 relative  w-full h-[280px] shadow-2xl overflow-hidden bg-cover bg-center " style={{backgroundImage: `url(${backgroundImageUrl})`, backgroundRepeat: 'repeat'}}>
