...
export default function AllEvent() {
  ...
  const handleEdit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append("EventDateTime", modal.eventDateTime);

      const response = await axios.put(`${process.env.REACT_APP_API_URL}/Event/${modal.id}`, formDataToSend);
