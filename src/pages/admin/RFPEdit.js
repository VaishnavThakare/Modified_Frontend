...
const RFPEdit = () => {
  ...
  const handleFile = (e)=>{
    ...
    Rfp.DocumentFile = e.target.files[0];
  }
  ...
  const handleSubmit = async (event) => {
    ...
    // try {
        ...
        // formData.append("DocumentFile",rfp.DocumentFile);
    ...
    //     navigate(`/admin/rfp`); // Redirect to projects list after successful update
    //   } else {
  ...
  return (
    ...
    <div className="flex text-2xl font-bold text-gray-500">
          <h2 className="text-left text-cyan-500">EDIT RFP</h2>
        </div>
