...
export default function AdminDash() {
  ...
  const [projectHead, setprojectHead] = useState(0);
...
///
        ...
        setVendor(vendorRes.data.length);

        const projectHeadRes = await axios.get(
          `${process.env.REACT_APP_API_URL}/ProjectHead/All`
        );

        setprojectHead(projectHeadRes.data.length);
      } catch (error) {
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
          <div class="flex justify-between mb-4">
            <div>
              <div class="flex items-center mb-1">
                <div class="text-2xl font-semibold">{vendor}</div>
        ...
        <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
          <div class="flex justify-between mb-4">
            <div>
              ...
              <div class="text-sm font-medium text-gray-400">Project Heads</div>
            </div>
          </div>
          <a
            href="/admin/allusers"
